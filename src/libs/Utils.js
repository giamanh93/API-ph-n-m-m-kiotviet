...
const patent_random_srting = '0123456789abcdefghijklmnopqrstuvwxyz';
const patent_random_srting_length = patent_random_srting.length;

export const getPassword = (password) => {
	return sha256(`MANH-${password}`);
};
